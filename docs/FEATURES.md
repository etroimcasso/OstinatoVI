...
| build-system | ✅ complete | `features/build-system.md` | CMake + `add_subdirectory(engine)`; 7 targets (lib / binary / smoke + enum + data + spell + item test runners); GoogleTest 33/35/2; lean binary; dev populate. Engine pin `7c3707a` |
